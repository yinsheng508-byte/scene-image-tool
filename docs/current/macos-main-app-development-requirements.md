...
- PR #13 / MAC-11 已新增 runtime manifest 和 provisioning script；当前不会下载或提交大资源，VC redist 已有 sha256，字体和 Windows LibreOffice runtime 逐文件 checksum 仍待授权和 artifact 存储确定后补齐。
